...
For best visibility, set 'Sector light mode' to "Classic (Faster)" in
"Display Options -> Hardware Renderer". If you want to use other 'Sector
light mode' settings, set 'Fog mode' to "Radial".
