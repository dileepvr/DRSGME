...
- Nash Muhandes
- Jay (Author of [[https://github.com/RicardoLuis0/AimAssist][AimAssist]])
...
in [[https://github.com/mmaulwurff/target-spy][Target-Spy]] and Jay's work in [[https://github.com/RicardoLuis0/AimAssist][AimAssist]], and are licensed under
GPLv3 (see [[./GPLv3.txt]]).
